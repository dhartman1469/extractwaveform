...
for idx, path in enumerate(html_paths):
        ...
        if path.lower().endswith('.html'):
                ...
                name = 'EXCEL/' + short_html_files[idx] + '_' + 'EXCEL' + '.xls'  
                ...
                dict = {}
                lst =  [line for line in (ch.splitlines(True))]
                i = 0;
                dict[0] = ['']
                ###
                skip_flag = False
                ...
                for indx, itm in enumerate(lst):
                        if "ctx.moveTo(1867.936198, 1757.486979)" in itm:
                                nxt_lst = lst[indx+1]
                                bar_coord = nxt_lst[12:-3]
                                bar_split_coord = bar_coord.split(', ')
                        elif "ctx.lineWidth" in itm:
                ...
                dict_x_X_axis = [1867.936198, bar_split_coord[0]]
                dict_y_X_axis = [1757.486979, bar_split_coord[1]]
                ax1.plot(dict_x_X_axis, dict_y_X_axis)
